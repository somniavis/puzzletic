      ...
      <div className="food-menu" onClick={(e) => e.stopPropagation()}>
        ...
        {currentView === 'language' && (
          <div className="food-items-grid">
            ...
            <button
              className={`food-item ${i18n.language === 'en-UK' ? 'food-item--selected' : ''}`}
              onClick={() => handleLanguageSelect('en-UK')}
            >
              <span className="food-item-icon language-flag">🇬🇧</span>
              <div className="language-info">
                <span className="food-item-name">English (UK)</span>
              </div>
              {i18n.language === 'en-UK' && (
                <div className="food-item-effects">
                  <span className="effect effect--selected">✓ {t('settings.language.selected')}</span>
            ...
            <button
              className={`food-item ${i18n.language === 'id-ID' ? 'food-item--selected' : ''}`}
              onClick={() => handleLanguageSelect('id-ID')}
            >
              <span className="food-item-icon language-flag">🇮🇩</span>
              <div className="language-info">
                <span className="food-item-name">Bahasa Indonesia</span>
              </div>
              {i18n.language === 'id-ID' && (
                <div className="food-item-effects">
                  <span className="effect effect--selected">✓ {t('settings.language.selected')}</span>
            ...
            <button
              className={`food-item ${i18n.language === 'fr-FR' ? 'food-item--selected' : ''}`}
              onClick={() => handleLanguageSelect('fr-FR')}
            >
              <span className="food-item-icon language-flag">🇫🇷</span>
              <div className="language-info">
                <span className="food-item-name">Français</span>
              </div>
              {i18n.language === 'fr-FR' && (
                <div className="food-item-effects">
                  <span className="effect effect--selected">✓ {t('settings.language.selected')}</span>
