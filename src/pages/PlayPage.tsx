...
const getIconBackground = (thumbnail: string | React.ReactNode | undefined): string => {
    // if (isLocked) return '#f1f5f9'; // Removed to show colors even when locked (handled by CSS opacity)
...
const renderThumbnail = (thumbnail: string | React.ReactNode | undefined, category: string) => {
