    ...
    emotions: {
        ...
        love: {
            ...
            l2: {
                ...
                shy: ['(수줍)', '좋아해요..', '두근두근..'],
                grumpy: ['..따뜻하네.', '잠깐만이야.', '흠..'],
                energetic: ['우정 파워!', '합체!', '영원히!'],
            },
            l3: {
                affectionate: ['평생 함께!', '나만의 것!', '사랑듬뿍!'],
                playful: ['넌 내 포로!', '절친 인증!', '대장님!'],
        ...
        playful: {
            ...
            l2: {
                ...
                calm: ['흥미롭네요.', '재밌군요.', '후후.'],
                shy: ['(빼꼼)', '저기..', '놀랐죠?'],
                grumpy: ['건들지 마.', '귀찮아.', '저리가.'],
                energetic: ['점프!', '구르기!', '백덤블링!'],
            },
            l3: {
                affectionate: ['너무 신나!', '하늘 날듯!', '빙글빙글'],
                playful: ['대폭발!', '초토화!', '무적이다!'],
                calm: ['감동적이에요.', '놀랍군요.', '박수!'],
                shy: ['(숨어서 웃음)', '이런 기분 처음..', '와아..'],
                grumpy: ['깜짝이야!', '제법인데?', '오호.'],
                energetic: ['한계를 돌파!', '멈출 수 없어!', '초고속!'],
            },
        },
        neutral: {
            l1: {
            ...
            l2: {
                ...
                calm: ['생각 중.', '명상 중.', '휴식.'],
                shy: ['(꼼지락)', '혼자네..', '조용..'],
                grumpy: ['건들면 문다.', '내버려둬.', '쳇.'],
                energetic: ['근질근질!', '답답해!', '으아아!'],
            },
            l3: {
                affectionate: ['나 잊었어?ㅠ', '외로워..', '흑흑'],
                playful: ['다 부순다?', '가만 안 둬!', '복수할 거야.'],
                calm: ['고독하군요.', '침묵.', '무념무상.'],
                shy: ['(훌쩍)', '무서워..', '어두워..'],
                grumpy: ['꺼져!', '시끄러워.', '폭발 직전.'],
        ...
        sleepy: {
            ...
            l2: {
                ...
                calm: ['깊은 잠.', '숙면 중.', '조용히.'],
                shy: ['(이불 콕)', '..쿨쿨', '잘 자요..'],
                grumpy: ['건들면 죽음.', '..으르렁.', '저리가.'],
                energetic: ['충전 중!', '파워..오프.', '방전.'],
            },
            l3: {
        ...
        sick: {
            l1: {
                ...
                playful: ['으윽!', '안 아픈데?', '아야!'],
                calm: ['몸이 안 좋네요.', '어지러워요.', '휴식 필요.'],
                shy: ['(끙끙)', '아파..', '훌쩍..'],
                grumpy: ['젠장.', '아프잖아.', '짜증나.'],
                energetic: ['왜 이러지?', '힘 안 나..', '비틀..'],
            },
            l2: {
                affectionate: ['너무 아파..', '살려줘..', '엉엉'],
                playful: ['꽥!', '살려사람!', '어질어질'],
                calm: ['심각하군요.', '열이 나요.', '약 좀..'],
                shy: ['(식은땀)', '무서워..', '도와줘요..'],
                grumpy: ['약 내놔!', '망할 몸뚱이.', '크윽..'],
                energetic: ['일어날 수 없어..', '내가 지다니..', '털썩.'],
            },
            l3: {
                affectionate: ['죽을 것 같아..', '안녕..', '사랑했어..'],
                playful: ['꿱.', '게임 오버.', '...'],
                calm: ['한계입니다.', '시야가 흐려요.', '...'],
                shy: ['(기절)', '...', '살려줘..'],
                grumpy: ['두고 보자..', '...', '끄악!'],
                energetic: ['시스템 종료.', '...', '재부팅 불가.'],
            },
        },
        worried: {
            l1: {
                affectionate: ['괜찮아?', '걱정돼..', '조심해'],
                playful: ['어라?', '큰일 났다!', '오잉?'],
                calm: ['주시 중.', '문제 발생.', '신중하게.'],
                shy: ['어쩌지..', '안절부절..', '히잉..'],
                grumpy: ['뭐야?', '기분 나빠.', '불길해.'],
                energetic: ['비상!', '위험해!', '조심!'],
            },
            l2: {
                affectionate: ['무서워..', '지켜줘..', '떨려..'],
                playful: ['도망쳐!', '망했다!', '으악!'],
                calm: ['경고합니다.', '위험 수위.', '대피하세요.'],
                shy: ['(덜덜)', '숨을래..', '못 보겠어..'],
                grumpy: ['짜증 폭발.', '다 덤벼.', '으르렁.'],
                energetic: ['패닉!', '살려주세요!', '우당탕탕!'],
            },
            l3: {
                affectionate: ['가지 마..', '혼자는 싫어..', '패닉..'],
                playful: ['으앙!', '살려줘!', '엄마야!'],
                calm: ['절망적.', '통제 불능.', '끝입니다.'],
                shy: ['(기절)', '눈물 펑펑', '말도 안 돼..'],
                grumpy: ['다 끝장이야!', '망했어.', '아오!'],
                energetic: ['멘탈 붕괴!', '와르르!', '살려줘!!'],
            },
        },
        angry: {
            l1: {
            ...
            l2: {
                affectionate: ['정말 미워!', '안 놀아!', '배신자!'],
                playful: ['폭발한다!', '물어버릴 거야!', '크앙!'],
                calm: ['경고했습니다.', '용서 못 해요.', '선 넘네요.'],
                shy: ['(엉엉)', '저리 가!', '싫어!'],
                grumpy: ['죽고 싶냐?', '눈 깔아.', '박살낸다.'],
                energetic: ['화가 난다!!', '분노 폭발!', '다 덤벼!'],
            },
            l3: {
                affectionate: ['절교야!', '꼴도 보기 싫어!', '흥!!'],
                playful: ['대폭주!', '파괴한다!', '멸망이다!'],
                calm: ['손절합니다.', '차단.', '끝.'],
                shy: ['(대성통곡)', '흐앙!!', '으아앙!'],
                grumpy: ['지옥행이다.', '사라져라.', '🤬'],
                energetic: ['슈퍼 분노!', '지구 뿌셔!', '폭주!'],
            },
        },
    },
    abandonment: {
