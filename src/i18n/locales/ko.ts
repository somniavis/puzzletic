...
import signShifterLocale from '../../games/math/adventure/level3/SignShifter/locales/ko';
...
const koBase = {
    profile: {
        ...
        cancelConfirmMessage: '현재 구독 종료일까지는 프리미엄을 계속 이용할 수 있습니다.\n추가 결제는 이루어지지 않습니다.',
        cancelSuccess: '구독이 취소되었습니다.',
        cancellationScheduledBadge: '자동 갱신 해제',
        cancellationScheduledMessage: '현재 구독 종료일까지는 프리미엄을 계속 이용할 수 있습니다.',
        upgradePrompt: '업그레이드',
        ...
        profileInfo: '계정',
        paymentInfo: '결제',
        checkoutKicker: '안전한 결제',
        checkoutAriaLabel: '안전한 결제 창',
        checkoutTitle: '패스 구매',
        ...
        purchaseResult: {
            success: '구매가 완료되었습니다.',
            failure: '구매에 실패했습니다.',
            failureDetailed: '구매를 완료하지 못했습니다. 잠시 후 다시 시도해 주세요.',
        },
        cancelFailure: '지금은 구독을 취소할 수 없습니다. 잠시 후 다시 시도해 주세요.',
        cancelErrors: {
            alreadyInProgress: '취소 요청이 이미 처리 중입니다. 잠시만 기다려 주세요.',
            rateLimited: '요청이 너무 많습니다. 잠시 후 다시 시도해 주세요.',
            managedExternally: '이 패스는 Xsolla에서 취소하고 검증된 업데이트를 기다려 주세요.',
        },
