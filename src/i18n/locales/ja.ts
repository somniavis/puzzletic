    ...
    emotions: {
        joy: {
            l1: {
                ...
                playful: ['いえーい！', 'たのしー！', 'へへっ'],
                calm: ['いいですね。', 'うん。', '良好です。'],
                shy: ['いいかも..', 'えへへ..', 'やったぁ..'],
                grumpy: ['ふん。', 'ま、いっか。', 'へー。'],
                energetic: ['最高！', 'うぉー！', 'いけー！'],
            },
            l2: {
                affectionate: ['たのしい！', 'しあわせ～', 'キャハッ！'],
                playful: ['あはは！', 'もっと！', 'サイコー！'],
                calm: ['楽しいですね。', '満足です。', '心地よい。'],
                shy: ['うれしい..', 'よかった..', 'えへへ..'],
                grumpy: ['悪くない。', 'へへ。', 'ふむ。'],
                energetic: ['超楽しい！', '全力だ！', 'もっと遊ぼ！'],
            },
            l3: {
                affectionate: ['大好き！', '最高の日！', 'ハッピー！'],
                playful: ['ウケる！', '大爆笑！', 'あははは！'],
                calm: ['素晴らしい。', '愉快です。', '完璧。'],
                shy: ['夢みたい..', '最高..', 'ふわふわ..'],
                grumpy: ['やるな。', '認める。', 'ハハ。'],
                energetic: ['楽しすぎ！', '限界突破！', 'イエーーイ！'],
            },
        },
        love: {
            l1: {
                affectionate: ['チュッ', 'かわいい..', 'なでなで'],
                playful: ['つかまえた！', '好き！', 'ギュッ！'],
                calm: ['優しいですね。', '好きです。', '安心します。'],
                shy: ['（ぽっ）', 'すき..', 'えへ..'],
                grumpy: ['なんだよ。', 'ふん。', 'べ、別に。'],
                energetic: ['好きー！', 'ハート！', 'チュッ！'],
            },
            l2: {
                affectionate: ['抱きしめて！', 'あったかい～', 'むぎゅ～'],
                playful: ['キス！', '離さない！', 'だいすき！'],
                calm: ['愛しいです。', '大切にします。', '温かい。'],
                shy: ['大好き..', '恥ずかしい..', 'ドキドキ..'],
                grumpy: ['温かいな。', '悪くない。', 'ちょっとだけ。'],
                energetic: ['ラブ注入！', '最強の愛！', '大好きだー！'],
            },
            l3: {
                affectionate: ['ずっと一緒！', '愛してる！', '貴方だけ！'],
                playful: ['僕の虜！', '超大好き！', '離れない！'],
                calm: ['心から感謝。', '愛しています。', '運命ですね。'],
                shy: ['（無言のハグ）', '愛してる..', '幸せ..'],
                grumpy: ['お前だけだ。', '勘違いすんなよ', 'そばにいて。'],
                energetic: ['ベストコンビ！', '永遠に！', '超絶ラブ！'],
            },
        },
        playful: {
            l1: {
                affectionate: ['パクッ！', 'おいしい～', 'あま～い'],
                playful: ['もぐもぐ！', 'うまー！', 'へへっ'],
                calm: ['いただきます。', '美味ですね。', 'ふむ。'],
                shy: ['もぐもぐ..', 'おいしい..', 'んん..'],
                grumpy: ['食えるな。', 'まあまあ。', 'ふん。'],
                energetic: ['うまっ！', 'おかわり！', 'ガツガツ'],
            },
            l2: {
                affectionate: ['あそんで！', 'くすぐったい！', 'キャハ'],
                playful: ['くらえ！', '攻撃！', 'ベロベロバー！'],
                calm: ['面白いですね。', '興味深い。', 'フフ。'],
                shy: ['（ちらっ）', 'あのね..', '驚いた？'],
                grumpy: ['やめろよ。', 'うっとおしい。', 'あっち行け。'],
                energetic: ['ジャンプ！', '回転！', 'ダッシュ！'],
            },
            l3: {
                affectionate: ['楽しすぎ！', '空飛べそう！', 'ルンルン'],
                playful: ['大暴れ！', '破壊！', '無敵だ！'],
                calm: ['感動しました。', '驚きです。', '拍手。'],
                shy: ['（隠れて笑う）', 'こんなの初めて..', 'わぁ..'],
                grumpy: ['ビビった？', 'やるじゃん。', 'へえ。'],
                energetic: ['限界突破！', '止まらない！', '超高速！'],
            },
        },
        neutral: {
            l1: {
                affectionate: ['つまんない..', 'あそんで..', 'うぅ..'],
                playful: ['暇ー！', 'なんかして！', 'ブーブー'],
                calm: ['静かですね。', '...', '平和です。'],
                shy: ['あの..', '...', 'どうしよ..'],
                grumpy: ['退屈。', 'はぁ..', 'つまらん。'],
                energetic: ['体なまった！', '外出よう！', '暇すぎ！'],
            },
            l2: {
                affectionate: ['会いたい..', 'どこ？', '待ってる'],
                playful: ['じーっ', 'つんつん', 'おーい！'],
                calm: ['思索中。', '瞑想。', '休憩。'],
                shy: ['（もじもじ）', 'ひとり..', 'シーン..'],
                grumpy: ['触んな。', 'ほっとけ。', 'チッ。'],
                energetic: ['ムズムズ！', 'じっとしてない！', 'うあー！'],
            },
            l3: {
                affectionate: ['忘れたの？涙', 'さみしい..', 'ううっ'],
                playful: ['暴れるぞ！', '許さん！', '復讐だ！'],
                calm: ['孤独です。', '沈黙。', '無。'],
                shy: ['（グスン）', 'こわい..', '暗い..'],
                grumpy: ['消えろ！', 'うるさい。', '爆発寸前。'],
                energetic: ['我慢できない！', '叫びたい！', 'うわああ！'],
            },
        },
        sleepy: {
            l1: {
                affectionate: ['ねむいよぉ..', 'トントンして..', '抱っこzZ'],
                playful: ['寝ないもん！', 'あそぶ..', 'こっくり..'],
                calm: ['ふぁ。', '疲れました。', '休みます。'],
                shy: ['（うとうと）', '寝ていい？', 'ふぁ..'],
            ...
            l2: {
                affectionate: ['夢の中へ..', 'ふわふわ..', 'すやすや'],
                playful: ['ぐーぐー！', 'ぷはー..', 'ムニャムニャ'],
                calm: ['熟睡。', '安眠。', '静粛に。'],
                shy: ['（布団被る）', '..すーすー', 'おやすみ..'],
                grumpy: ['触るな死ぬぞ。', '..うぅ。', 'あっち行け。'],
                energetic: ['充電中！', 'パワー..オフ。', '放電。'],
            },
            l3: {
                affectionate: ['おやすみ..', '大好き..', 'zZzZ'],
                playful: ['クークー..', 'プピー..', 'ドタッ！'],
                calm: ['...', '......', '（沈黙）'],
                shy: ['（すやすや）', '...', 'zZ..'],
                grumpy: ['...', '近寄るな..', '...'],
                energetic: ['...', '完全停止。', '（気絶）'],
        ...
        sick: {
            l1: {
                affectionate: ['いたい..', 'よしよしして..', 'うぅ..'],
                playful: ['うぐっ！', '痛くないもん', 'イタッ！'],
                calm: ['不調です。', 'めまいが。', '休息を。'],
                shy: ['（うるうる）', 'いたいよぉ..', 'ぐすん..'],
                grumpy: ['クソッ。', '痛え。', 'イライラする。'],
                energetic: ['なんか変..', '力が出ない..', 'フラフラ..'],
            },
            l2: {
                affectionate: ['すごく痛い..', '助けて..', 'あああん'],
                playful: ['ギャッ！', 'しぬー！', 'クラクラ'],
                calm: ['深刻です。', '熱があります。', '薬を..'],
                shy: ['（冷や汗）', 'こわいよ..', '助けて..'],
                grumpy: ['薬よこせ！', '動けねえ。', 'くっ..'],
                energetic: ['立てない..', '負けた..', 'バタリ。'],
            },
            l3: {
                affectionate: ['死んじゃう..', 'さよなら..', '愛してた..'],
                playful: ['グハッ。', 'ゲームオーバー。', '...'],
                calm: ['限界です。', '視界が..', '...'],
                shy: ['（気絶）', '...', '助けて..'],
                grumpy: ['覚えてろ..', '...', 'ぐはぁ！'],
                energetic: ['システム終了。', '...', '再起動不可。'],
            },
        },
        worried: {
            l1: {
                ...
                calm: ['注視中。', '問題発生。', '慎重に。'],
                shy: ['どうしよ..', 'ソワソワ..', 'ひぃ..'],
                grumpy: ['なんだ？', '気分悪い。', '嫌な予感。'],
                energetic: ['緊急！', 'あぶない！', '注意！'],
            },
            l2: {
                affectionate: ['こわいよ..', '守って..', '震える..'],
                playful: ['逃げろ！', '終わった！', 'うわぁ！'],
                calm: ['警告します。', '危険水位。', '避難を。'],
                shy: ['（ガタガタ）', '隠れる..', '見れない..'],
                grumpy: ['イラつく。', '全員敵か。', 'グルル。'],
                energetic: ['パニック！', '助けて！', 'ドタバタ！'],
            },
            l3: {
                affectionate: ['行かないで..', '一人は嫌..', 'パニック..'],
                playful: ['うわーん！', 'たすけて！', 'ママ－！'],
                calm: ['絶望的。', '制御不能。', '終わりです。'],
                shy: ['（気絶）', '涙ボロボロ', '信じられない..'],
                grumpy: ['もう終わりだ！', 'クソが！', 'あぁ！'],
                energetic: ['メンタル崩壊！', 'あわわ！', '助けて！！'],
            },
        },
        angry: {
            l1: {
                affectionate: ['ふん！', 'きらい！', 'ぷいっ'],
                playful: ['えいっ！', 'ポカポカ', '攻撃！'],
            ...
            l2: {
                affectionate: ['本当にきらい！', '遊ばない！', '裏切り者！'],
                playful: ['大爆発！', '噛みつくぞ！', 'ガオー！'],
                calm: ['警告しましたよ。', '許しません。', '越えましたね。'],
                shy: ['（号泣）', 'あっち行って！', 'ヤダ！'],
                grumpy: ['死にてぇのか？', '目障りだ。', '潰す。'],
                energetic: ['激おこ！！', '怒り爆発！', 'かかってこい！'],
            },
            l3: {
                affectionate: ['絶交だもん！', '顔も見たくない！', 'フン！！'],
                playful: ['暴走モード！', '破壊する！', '滅びろ！'],
                calm: ['縁を切ります。', 'ブロック。', '終了。'],
                shy: ['（大泣き）', 'うわぁぁん！', '許さない！'],
                grumpy: ['地獄行きだ。', '消え失せろ。', '🤬'],
                energetic: ['スーパー激怒！', '地球壊す！', '暴走！'],
            },
        },
    },
    abandonment: {
