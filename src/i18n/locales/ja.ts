...
import signShifterLocale from '../../games/math/adventure/level3/SignShifter/locales/ja';
    ...
    profile: {
        ...
        subscription: {
            quarterly: {
                ...
                subscriptionDesc: '$3.99、四半期ごとに請求',
                durationTitle: '3か月Jello Pass',
                durationDesc: '$3.99',
            },
            yearly: {
                subscriptionTitle: '年間Angel Pass',
                subscriptionDesc: '$12.00、年ごとに請求',
                durationTitle: '12か月Angel Pass',
                durationDesc: '$12.00',
                badge: 'おすすめ',
            },
            unit: '/ 月',
        ...
        profileInfo: 'アカウント',
        paymentInfo: 'お支払い',
        checkoutKicker: '安全な決済',
        checkoutAriaLabel: '安全な決済ダイアログ',
        checkoutTitle: 'パス購入',
        checkoutPreparing: '決済を準備中...',
        purchaseButton: '購入',
        expiresLabel: '有効期限',
        purchaseConfirm: {
            threeMonths: '3か月プランを購入しますか？',
            twelveMonths: '1年プランを購入しますか？',
        },
        purchaseResult: {
            success: '購入が完了しました。',
            failure: '購入に失敗しました。',
            failureDetailed: '購入を完了できませんでした。しばらくしてからもう一度お試しください。',
        },
        cancelFailure: '現在はサブスクリプションをキャンセルできません。しばらくしてからもう一度お試しください。',
        cancelErrors: {
            alreadyInProgress: 'キャンセル処理はすでに進行中です。しばらくお待ちください。',
            rateLimited: 'リクエストが多すぎます。少し待ってから再度お試しください。',
            managedExternally: 'このパスはXsolla側でキャンセルし、検証済みの更新をお待ちください。',
        },
        cancelAnytimeShort: 'いつでも解約可能',
        oneTimePurchaseNote: '自動更新なし',
        badges: {
            recommended: 'おすすめ',
            subscription: 'サブスク',
            mostPopular: '人気',
        ...
        parentGate: {
            title: 'エンジェルパス',
            instruction: '下に表示された数字を入力してください',
            error: '数字が違います。もう一度お試しください。',
            clear: 'クリア',
            reset: '新しい数字',
            displayLabel: '入力した数字',
            numberWords: {
    ...
    emotions: {
        ...
        neutral: {
            ...
            l3: {
                ...
                playful: ['滅茶苦茶だ！', '許さないぞ！', 'いたずらする？'],
                calm: ['孤独ですね。', '沈黙。', '呆然。'],
                shy: ['(グスン)', '怖い..', '暗い..'],
                grumpy: ['あっち行け。', 'しずかに。', '気分最悪。'],
                energetic: ['もどかしい！', '飛び出したい！', 'ああ！'],
            },
        },
        sleepy: {
            l1: {
        ...
        angry: {
            ...
            l2: {
                ...
                shy: ['(号泣)', 'あっち行って！', 'ヤダ！'],
                grumpy: ['イライラ。', '見るな。', '怒った。'],
                energetic: ['怒った！', 'イライラ！', 'かかってこい！'],
            },
            l3: {
                affectionate: ['絶交だ！', '顔も見たくない！', 'フン！！'],
                playful: ['どたばた！', 'すごく怒る！', '許さない！'],
                calm: ['もう知りません。', 'ブロック。', '終わり。'],
                shy: ['(大泣き)', 'うわぁぁん！', 'うわぁ！'],
                grumpy: ['怒った。', 'あっち行け。', 'もう知らん！'],
                energetic: ['すごく怒る！', 'うわー！', '暴走！'],
            },
        },
                        toddler: {
                  "joy": {
        ...
        eat: {
            l1: {
                affectionate: ['おいしい！', 'いいね！', 'うれしい！'],
                playful: ['もぐもぐ！', 'もっと！', 'ぱくっ！'],
                calm: ['いい。', 'おいしい。', 'ふむ。'],
                shy: ['おいしい..', 'もぐ..', 'いい..'],
                grumpy: ['悪くない。', 'まあね。', 'ふん。'],
                energetic: ['よし！', 'もっと！', 'げんき！'],
            },
            l2: {
                affectionate: ['おいしい！', 'いいね！', 'うれしい！'],
                playful: ['もぐもぐ！', 'もっと！', 'ぱくっ！'],
        ...
        eat_aftereffect: {
            l1: {
                affectionate: ['あれ..?', 'おなか..', 'あっ..'],
                playful: ['ぐるる！', 'おっと！', 'まって！'],
                calm: ['サイン..', 'うーん..', 'ちょっと..'],
                shy: ['あっ..', 'しー..', 'うぅ..'],
                grumpy: ['また..?', 'うぅ..', 'いま..？'],
                energetic: ['はやく！', 'どいて！', 'まって！'],
            },
            l2: {
                affectionate: ['あれ..?', 'おなか..', 'あっ..'],
                playful: ['ぐるる！', 'おっと！', 'まって！'],
        ...
        medicine_pill: {
            l1: {
                affectionate: ['のむね..', 'おくすり..', 'よくなる？'],
                playful: ['にがい..！', 'うえっ！', 'のむの？'],
                calm: ['ゆっくり..', 'のもう..', 'うーん..'],
                shy: ['こわい..', 'にがい..', 'やってみる..'],
                grumpy: ['きらい。', 'にがすぎ。', 'ふん..'],
                energetic: ['ごくっ！', 'なおす！', 'いける！'],
            },
            l2: {
                affectionate: ['のむね..', 'おくすり..', 'よくなる？'],
                playful: ['にがい..！', 'うえっ！', 'のむの？'],
        ...
        medicine_shot: {
            l1: {
                affectionate: ['ちゅうしゃ..?', 'いたっ！', 'もうすぐ..'],
                playful: ['ひゃっ！', 'うわっ！', 'ああ！'],
                calm: ['ちょっとだけ..', 'がんばる..', 'だいじょうぶ..'],
                shy: ['こわい..', 'めをつぶる..', 'ふるえる..'],
                grumpy: ['いやだ。', 'いたいのやだ。', 'ふん..'],
                energetic: ['いける！', 'あとちょっと！', 'たえる！'],
            },
            l2: {
                affectionate: ['ちゅうしゃ..?', 'いたっ！', 'もうすぐ..'],
                playful: ['ひゃっ！', 'うわっ！', 'ああ！'],
        ...
        clean_spot: {
            l1: {
                affectionate: ['きれい！', 'ありがとう！', 'よくなった！'],
                playful: ['さっさっ！', 'きえた！', 'ぴかっ！'],
                calm: ['すっきり。', 'きれい。', 'いいね。'],
                shy: ['ほっ..', 'よかった..', 'だいじょうぶ..'],
                grumpy: ['ましだ。', 'そうじだ。', 'ふん。'],
                energetic: ['かんりょう！', 'すっきり！', 'ぴかっ！'],
            },
            l2: {
                affectionate: ['きれい！', 'ありがとう！', 'よくなった！'],
                playful: ['さっさっ！', 'きえた！', 'ぴかっ！'],
        ...
        clean_fresh: {
            l1: {
                affectionate: ['さっぱり！', 'いいね！', 'きもちいい！'],
                playful: ['ぴかぴか！', 'ふわふわ！', 'いい！'],
                calm: ['きれい。', 'さわやか。', 'いい。'],
                shy: ['ふわふわ..', 'いいかんじ..', 'いいにおい..'],
                grumpy: ['まあいい。', 'ましだ。', 'いい。'],
                energetic: ['ちょうさっぱり！', 'あたらしい！', 'いくぞ！'],
            },
            l2: {
                affectionate: ['さっぱり！', 'いいね！', 'きもちいい！'],
                playful: ['ぴかぴか！', 'ふわふわ！', 'いい！'],
