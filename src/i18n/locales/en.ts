...
export const en = {
  ...
  common: {
    ...
    modal: {
      ...
      desc: 'This game is available for <bold>Premium Users only</bold>.<br/>Start growing <bold>3x faster</bold> now! 🚀',
      benefit1: 'Unlock ALL 20+ Games',
      benefit2: 'Earn 3x-8x More XP',
      benefit3: 'Exclusive Jello Evolutions',
    },
    loading: 'Loading...',
    confirm: 'Confirm',
    close: 'Close',
