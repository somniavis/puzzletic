...
import tenFrameNumberLocale from '../../games/math/adventure/level1/TenFrameNumber/locales/en';
import tenFrameAddLocale from '../../games/math/adventure/level1/TenFrameAdd/locales/en';
import moleWhackLocale from '../../games/math/adventure/level1/MoleWhack/locales/en';
...
import jelloFeedingEn from '../../games/math/adventure/level1/JelloFeeding/locales/en';
...
import donutShopLocale from "../../games/math/adventure/level3/DonutShop/locales/en";
import chocolateSplitLocale from "../../games/math/adventure/level3/ChocolateSplit/locales/en";
import scorpionKingLocale from "../../games/math/adventure/level3/ScorpionKing/locales/en";
import pizzaPizzaLocale from "../../games/math/adventure/level3/PizzaPizza/locales/en";
  ...
  emotions: {
    ...
    toddler: {
      ...
      worried: {
        ...
        l3: { affectionate: ['😭 No go..', '💔 Lonely..', '🧟 Scary..'], playful: ['😭 Waa!', '🚑 Help!', '🤱 Mama!'], calm: ['📉 Bad.', '🧩 Hard.', '❌ No.'], shy: ['🥀 Thud', '💦 Tears', '😱 No way..'], grumpy: ['🚮 Trouble!', '😫 Doomed.', '🤬 Ugh!'], energetic: ['🤯 What!', '🧱 Crash!', '🆘 Help!!'] },
      },
      angry: {
