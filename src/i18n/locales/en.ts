...
import colorMixEn from '../../games/brain/level2/ColorMix/locales/en';
...
export const en = {
  profile: {
    ...
    cancellationScheduledBadge: 'Auto-Renew Off',
    cancellationScheduledMessage: 'Premium remains active until your current subscription ends.',
    ...
    checkoutAriaLabel: 'Secure checkout dialog',
    ...
    purchaseResult: {
      ...
      failureDetailed: 'Purchase failed. Please try again shortly.',
    },
    cancelFailure: 'Unable to cancel the subscription right now. Please try again shortly.',
    cancelErrors: {
      alreadyInProgress: 'Cancellation is already in progress. Please wait a moment.',
      rateLimited: 'Too many requests. Please wait before trying again.',
      managedExternally: 'Please cancel this pass through Xsolla and wait for the verified update.',
    },
