...
import './Layout4.css'; // Use Layout4 CSS
...
export const Layout4: React.FC<Layout4Props> = ({
    title,
    subtitle,
    gameId,
    description,
    ...
    return (
        <div className="layout4-container">
            ...
            <div className="layout4-dashboard">
            ...
            <main className="layout4-game-area">
                {/* Game Area Wrapper (Centered) */}
                <div className="layout4-grid-wrapper">
                    {children}
                </div>
