...
const GAME_ID = GameIds.MAZE_ESCAPE;
...
export default function MazeEscape() {
    ...
    return (
        <Layout2
            ...
            instructions={[
                { icon: '🏕️', title: t('games.maze-escape.howToPlay.step1.title'), description: t('games.maze-escape.howToPlay.step1.description') },
                { icon: '✏️', title: t('games.maze-escape.howToPlay.step2.title'), description: t('games.maze-escape.howToPlay.step2.description') },
                { icon: '⚠️', title: t('games.maze-escape.howToPlay.step3.title'), description: t('games.maze-escape.howToPlay.step3.description') }
            ]}
        >
            <div
