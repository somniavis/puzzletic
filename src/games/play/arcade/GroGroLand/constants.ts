...
export const GROGRO_LAND_ENEMY_PERSONALITY_CONFIG = {
    conservative: {
        ...
        arcVariance: 10,
        arcTurnAngle: 1.08,
        returnEntryOffset: 112,
        decisionCooldown: 14,
        returnCooldown: 56,
        returnVariance: 10,
        turnJitter: 0.76,
        avoidTurnBoost: 1.5,
        selfAvoidMinTrailPoints: 12,
        selfAvoidHitRadius: 8,
        playerPressureRadius: 0,
        playerPressureTurn: 0,
    },
    balanced: {
        patrolCooldown: 46,
        patrolVariance: 8,
        ...
        arcVariance: 12,
        arcTurnAngle: 1.38,
        returnEntryOffset: 170,
        decisionCooldown: 10,
        returnCooldown: 42,
        returnVariance: 12,
        turnJitter: 0.92,
        avoidTurnBoost: 1.4,
        selfAvoidMinTrailPoints: 18,
        selfAvoidHitRadius: 6,
        playerPressureRadius: 0,
        playerPressureTurn: 0,
    },
    aggressive: {
        ...
        arcVariance: 18,
        arcTurnAngle: 1.6,
        returnEntryOffset: 220,
        decisionCooldown: 7,
        returnCooldown: 28,
        returnVariance: 16,
        turnJitter: 1.14,
        avoidTurnBoost: 1.3,
        selfAvoidMinTrailPoints: 24,
        selfAvoidHitRadius: 5,
        playerPressureRadius: 520,
        playerPressureTurn: 0.82,
    },
} as const;
