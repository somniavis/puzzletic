export default {
    ...
    announcements: {
        ...
        dangerDetail1: '새 적이 몰려옵니다.',
        dangerDetail2: '더 강한 적이 나타납니다.',
        dangerDetail3: '전장이 더 위험해집니다.',
        rangedTitle: '원거리 위협',
        rangedDetail: '{{name}}이 전장에 나타났습니다.',
        eliteTitle: '엘리트 출현',
        eliteDetail: '{{name}}이 아레나에 등장했습니다.',
    },
    enemyNames: {
        standard: '임프',
        swift: '스포어',
