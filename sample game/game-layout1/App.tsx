...
const translations: Record<LanguageCode, any> = {
  en: { title: "Fruit Slashy", subtitle: "Create the target number with the knife!", scoreLabel: "Score", livesLabel: "Lives", streakLabel: "Streak", timeLabel: "Time", difficulty_1: "Beginner", difficulty_2: "Intermediate", difficulty_3: "Advanced", question: "Your question here...", doubleScoreActive: "⚡2x ({timeLeft}s)", hintButton: "💡 Hint ({remaining}/3)", hintButtonClose: "Close Hint", hintLabel: "Hint:", hintUsedText: "(Hint used, 50% score penalty)", hintText_placeholder: "Your hint text goes here.", feedbackCorrect: "Correct! +{score} points", feedbackEmojiCorrect: "🎉", feedbackWrong: "Incorrect. 💔", achievementsTitle: "Achievements ({count}/4)", achievements_firstCorrect: "First Slice", achievements_lightningSpeed: "Quick Calc", achievements_streakMaster: "Combo King", achievements_master: "Fruit Master", achievementsTooltip_firstCorrect: "Solve your first puzzle.", achievementsTooltip_lightningSpeed: "Answer in under 3 seconds.", achievementsTooltip_streakMaster: "Get a 5-puzzle streak.", achievementsTooltip_master: "Correctly solve 3+ puzzles on Advanced difficulty.", gameOverTitle: "Game Over!", gameOverBadge: "End", finalScoreLabel: "Final Score", scoreUnit: " pts", difficultyReachedLabel: "Difficulty Reached", bestStreakLabel: "Best Streak", itemUnit: "", accuracyLabel: "Accuracy", achievementsEarnedLabel: "Achievements Unlocked", starsEarnedLabel: "Stars Earned", gameOverMessage_great: "🎉 Excellent work!", gameOverMessage_good: "👍 Well done!", gameOverMessage_tryAgain: "💪 You can do better next time!", gameOverMessage_cleared: "🏆 You've mastered all puzzles! Legendary!", playAgainButton: "Play Again", downloadResult: "Download Result", imageDownloaded: "Image downloaded!", imageDownloadFailed: "Failed to download image.", howToPlayButton: "How to Play", howToPlayTitle: "How to Play", howToPlay_goal_title: "Goal", howToPlay_goal_desc: "New game instructions go here.", howToPlay_time_lives_title: "Time & Bonus", howToPlay_time_lives_desc: "You start with 60 seconds. Answering correctly awards bonus time (up to 60s max) based on difficulty. Don't let the timer or your lives run out!", howToPlay_difficulty_title: "Difficulty", howToPlay_difficulty_desc: "The game adapts! The better you play, the harder the puzzles get, earning you more points.", howToPlay_streak_title: "Streak & Power-ups", howToPlay_streak_desc: "Achieve a 3-puzzle streak for a chance to earn a random power-up like ❄️ Time Freeze, ❤️ Extra Life, and ⚡ Double Score!", howToPlay_hints_title: "Hints", howToPlay_hints_desc: "Stuck? Use a hint! Be careful, it will cost you 50% of the score for that puzzle.", howToPlay_achievements_title: "Achievements", howToPlay_achievements_desc: "Unlock special achievements for completing milestones in the game.", closeButton: "Got it!", soundOnTooltip: "Play Music", soundOffTooltip: "Mute Music", startGameButton: "Start Game", footer_copyright: "Puzzletic. All rights reserved.", footer_contact: "Business Contact:" },
  ko: { title: "과일 슬래시", subtitle: "숫자 칼로 목표 숫자를 만들어 보세요!", scoreLabel: "점수", livesLabel: "생명력", streakLabel: "연속", timeLabel: "시간", difficulty_1: "초급", difficulty_2: "중급", difficulty_3: "고급", question: "질문을 여기에 입력하세요...", doubleScoreActive: "⚡2배 ({timeLeft}초)", hintButton: "💡 힌트 ({remaining}/3)", hintButtonClose: "힌트 닫기", hintLabel: "힌트:", hintUsedText: "(힌트 사용으로 50% 차감)", hintText_placeholder: "힌트 내용이 여기에 표시됩니다.", feedbackCorrect: "정답! +{score}점", feedbackEmojiCorrect: "🎉", feedbackWrong: "틀렸습니다. 💔", achievementsTitle: "업적 ({count}/4)", achievements_firstCorrect: "첫 슬라이스", achievements_lightningSpeed: "빠른 계산", achievements_streakMaster: "콤보 왕", achievements_master: "과일 마스터", achievementsTooltip_firstCorrect: "첫 퍼즐을 풀어보세요.", achievementsTooltip_lightningSpeed: "3초 안에 정답을 맞히세요.", achievementsTooltip_streakMaster: "5문제 연속 정답을 달성하세요.", achievementsTooltip_master: "고급 난이도에서 3문제 이상 정답을 맞히세요.", gameOverTitle: "게임 종료!", gameOverBadge: "끝", finalScoreLabel: "최종 점수", scoreUnit: "점", difficultyReachedLabel: "도달 난이도", bestStreakLabel: "최고 연속", itemUnit: "개", starsEarnedLabel: "획득 별", accuracyLabel: "정답률", achievementsEarnedLabel: "달성한 업적", gameOverMessage_great: "🎉 훌륭한 실력이에요!", gameOverMessage_good: "👍 잘 하셨어요!", gameOverMessage_tryAgain: "💪 다음엔 더 잘할 수 있어요!", gameOverMessage_cleared: "🏆 모든 퍼즐을 마스터했어요! 전설급 실력!", playAgainButton: "재도전하기", downloadResult: "결과 다운로드", imageDownloaded: "이미지를 다운로드했습니다!", imageDownloadFailed: "이미지 다운로드에 실패했습니다.", howToPlayButton: "게임 방법", howToPlayTitle: "게임 방법", howToPlay_goal_title: "목표", howToPlay_goal_desc: "새로운 게임 설명이 여기에 들어갑니다.", howToPlay_time_lives_title: "시간 & 보너스", howToPlay_time_lives_desc: "60초로 시작하며, 정답을 맞히면 난이도에 따라 보너스 시간을 얻습니다(최대 60초). 시간이나 생명력이 다 떨어지지 않게 주의하세요!", howToPlay_difficulty_title: "난이도", howToPlay_difficulty_desc: "게임은 당신의 실력에 맞춰집니다! 더 잘할수록 더 어려운 퍼즐이 나오고 더 많은 점수를 얻습니다.", howToPlay_streak_title: "연속 정답 & 아이템", howToPlay_streak_desc: "3연속 정답을 달성하면 ❄️ 시간 정지, ❤️ 추가 생명력, ⚡ 점수 2배와 같은 아이템을 무작위로 얻을 기회가 생깁니다!", howToPlay_hints_title: "힌트", howToPlay_hints_desc: "막혔나요? 힌트를 사용하세요. 하지만 해당 문제 점수의 50%가 차감되니 신중하게 사용하세요.", howToPlay_achievements_title: "업적", howToPlay_achievements_desc: "게임 내 특별한 목표를 달성하고 업적을 잠금 해제하세요.", closeButton: "알겠어요!", soundOnTooltip: "음악 재생", soundOffTooltip: "음악 음소거", startGameButton: "게임 시작", footer_copyright: "Puzzletic. 모든 권리 보유.", footer_contact: "비즈니스 문의:" },
  es: { title: "Fruit Slashy", subtitle: "¡Crea el número objetivo con el cuchillo!", scoreLabel: "Puntos", livesLabel: "Vidas", streakLabel: "Racha", timeLabel: "Tiempo", difficulty_1: "Principiante", difficulty_2: "Intermedio", difficulty_3: "Avanzado", question: "Tu pregunta aquí...", doubleScoreActive: "⚡2x ({timeLeft}s)", hintButton: "💡 Pista ({remaining}/3)", hintButtonClose: "Cerrar Pista", hintLabel: "Pista:", hintUsedText: "(Pista usada, 50% de penalización)", hintText_placeholder: "El texto de tu pista va aquí.", feedbackCorrect: "¡Correcto! +{score} puntos", feedbackEmojiCorrect: "🎉", feedbackWrong: "Incorrecto. 💔", achievementsTitle: "Logros ({count}/4)", achievements_firstCorrect: "Primer Corte", achievements_lightningSpeed: "Cálculo Rápido", achievements_streakMaster: "Rey del Combo", achievements_master: "Maestro de la Fruta", achievementsTooltip_firstCorrect: "Resuelve tu primer puzle.", achievementsTooltip_lightningSpeed: "Responde en menos de 3 segundos.", achievementsTooltip_streakMaster: "Consigue una racha de 5 aciertos.", achievementsTooltip_master: "Resuelve 3+ puzles en dificultad Avanzada.", gameOverTitle: "¡Fin del Juego!", gameOverBadge: "Fin", finalScoreLabel: "Puntuación Final", scoreUnit: " pts", difficultyReachedLabel: "Dificultad Alcanzada", bestStreakLabel: "Mejor Racha", itemUnit: "", accuracyLabel: "Precisión", achievementsEarnedLabel: "Logros Desbloqueados", starsEarnedLabel: "Estrellas Ganadas", gameOverMessage_great: "🎉 ¡Excelente trabajo!", gameOverMessage_good: "👍 ¡Bien hecho!", gameOverMessage_tryAgain: "💪 ¡Puedes hacerlo mejor la próxima vez!", gameOverMessage_cleared: "🏆 ¡Has dominado todos los puzles! ¡Legendario!", playAgainButton: "Jugar de Nuevo", downloadResult: "Descargar Resultado", imageDownloaded: "¡Imagen descargada!", imageDownloadFailed: "Error al descargar la imagen.", howToPlayButton: "Cómo Jugar", howToPlayTitle: "Cómo Jugar", howToPlay_goal_title: "Objetivo", howToPlay_goal_desc: "Las instrucciones del nuevo juego van aquí.", howToPlay_time_lives_title: "Tiempo y Bonus", howToPlay_time_lives_desc: "Empiezas con 60 segundos. Responder correctamente otorga tiempo extra (hasta 60s máximo) según la dificultad. ¡No dejes que el temporizador o tus vidas se agoten!", howToPlay_difficulty_title: "Dificultad", howToPlay_difficulty_desc: "¡El juego se adapta! Cuanto mejor juegues, más difíciles serán los puzles y más puntos ganarás.", howToPlay_streak_title: "Racha y Potenciadores", howToPlay_streak_desc: "¡Logra una racha de 3 puzles para tener la oportunidad de ganar un potenciador aleatorio como ❄️ Congelar Tiempo, ❤️ Vida Extra y ⚡ Puntuación Doble!", howToPlay_hints_title: "Pistas", howToPlay_hints_desc: "¿Atascado? ¡Usa una pista! Ten cuidado, te costará el 50% de la puntuación de ese puzle.", howToPlay_achievements_title: "Logros", howToPlay_achievements_desc: "Desbloquea logros especiales por completar hitos en el juego.", closeButton: "¡Entendido!", soundOnTooltip: "Reproducir música", soundOffTooltip: "Silenciar música", startGameButton: "Empezar Juego", footer_copyright: "Puzzletic. Todos los derechos reservados.", footer_contact: "Contacto comercial:" },
  fr: { title: "Fruit Slashy", subtitle: "Créez le nombre cible avec le couteau !", scoreLabel: "Score", livesLabel: "Vies", streakLabel: "Série", timeLabel: "Temps", difficulty_1: "Débutant", difficulty_2: "Intermédiaire", difficulty_3: "Avancé", question: "Votre question ici...", doubleScoreActive: "⚡2x ({timeLeft}s)", hintButton: "💡 Indice ({remaining}/3)", hintButtonClose: "Fermer l'Indice", hintLabel: "Indice :", hintUsedText: "(Indice utilisé, 50% de pénalité)", hintText_placeholder: "Le texte de votre indice va ici.", feedbackCorrect: "Correct ! +{score} points", feedbackEmojiCorrect: "🎉", feedbackWrong: "Incorrect. 💔", achievementsTitle: "Succès ({count}/4)", achievements_firstCorrect: "Première Tranche", achievements_lightningSpeed: "Calcul Rapide", achievements_streakMaster: "Roi du Combo", achievements_master: "Maître des Fruits", achievementsTooltip_firstCorrect: "Résolvez votre premier puzzle.", achievementsTooltip_lightningSpeed: "Répondez en moins de 3 secondes.", achievementsTooltip_streakMaster: "Obtenez une série de 5 puzzles.", achievementsTooltip_master: "Résolvez 3+ puzzles en difficulté Avancé.", gameOverTitle: "Partie Terminée !", gameOverBadge: "Fin", finalScoreLabel: "Score Final", scoreUnit: " pts", difficultyReachedLabel: "Difficulté Atteinte", bestStreakLabel: "Meilleure Série", itemUnit: "", accuracyLabel: "Précision", achievementsEarnedLabel: "Succès Déverrouillés", starsEarnedLabel: "Étoiles Obtenues", gameOverMessage_great: "🎉 Excellent travail !", gameOverMessage_good: "👍 Bien joué !", gameOverMessage_tryAgain: "💪 Vous pouvez faire mieux la prochaine fois !", gameOverMessage_cleared: "🏆 Vous avez maîtrisé tous les puzzles ! Légendaire !", playAgainButton: "Rejouer", downloadResult: "Télécharger le résultat", imageDownloaded: "Image téléchargée !", imageDownloadFailed: "Échec du téléchargement de l'image.", howToPlayButton: "Comment Jouer", howToPlayTitle: "Comment Jouer", howToPlay_goal_title: "But", howToPlay_goal_desc: "Les instructions du nouveau jeu vont ici.", howToPlay_time_lives_title: "Temps et Bonus", howToPlay_time_lives_desc: "Vous commencez avec 60 secondes. Répondre correctement octroie du temps bonus (jusqu'à 60s max) selon la difficulté. Ne laissez pas le temps ou vos vies s'épuiser !", howToPlay_difficulty_title: "Difficulté", howToPlay_difficulty_desc: "Le jeu s'adapte ! Mieux vous jouez, plus les puzzles deviennent difficiles, vous rapportant plus de points.", howToPlay_streak_title: "Série & Power-ups", howToPlay_streak_desc: "Réalisez une série de 3 puzzles pour avoir une chance de gagner un power-up aléatoire comme ❄️ Gel du Temps, ❤️ Vie Supplémentaire et ⚡ Score Double !", howToPlay_hints_title: "Indices", howToPlay_hints_desc: "Bloqué ? Utilisez un indice ! Attention, cela vous coûtera 50% du score pour ce puzzle.", howToPlay_achievements_title: "Succès", howToPlay_achievements_desc: "Déverrouillez des succès spéciaux en accomplissant des jalons dans le jeu.", closeButton: "Compris !", soundOnTooltip: "Lancer la musique", soundOffTooltip: "Couper la musique", startGameButton: "Commencer la Partie", footer_copyright: "Puzzletic. Tous droits réservés.", footer_contact: "Contact professionnel:" },
  de: { title: "Fruit Slashy", subtitle: "Erstelle die Zielzahl mit dem Messer!", scoreLabel: "Punkte", livesLabel: "Leben", streakLabel: "Serie", timeLabel: "Zeit", difficulty_1: "Anfänger", difficulty_2: "Mittel", difficulty_3: "Fortgeschritten", question: "Deine Frage hier...", doubleScoreActive: "⚡2x ({timeLeft}s)", hintButton: "💡 Tipp ({remaining}/3)", hintButtonClose: "Tipp schließen", hintLabel: "Tipp:", hintUsedText: "(Tipp verwendet, 50% Punktabzug)", hintText_placeholder: "Dein Tipp-Text kommt hierher.", feedbackCorrect: "Richtig! +{score} Punkte", feedbackEmojiCorrect: "🎉", feedbackWrong: "Falsch. 💔", achievementsTitle: "Erfolge ({count}/4)", achievements_firstCorrect: "Erster Schnitt", achievements_lightningSpeed: "Schnelle Rechnung", achievements_streakMaster: "König der Kombos", achievements_master: "Frucht-Meister", achievementsTooltip_firstCorrect: "Löse dein erstes Puzzle.", achievementsTooltip_lightningSpeed: "Antworte in unter 3 Sekunden.", achievementsTooltip_streakMaster: "Erreiche eine Serie von 5 Puzzles.", achievementsTooltip_master: "Löse 3+ Puzzles auf Schwierigkeit Fortgeschritten.", gameOverTitle: "Spiel Vorbei!", gameOverBadge: "Ende", finalScoreLabel: "Endpunktzahl", scoreUnit: " Pkt", difficultyReachedLabel: "Erreichte Schwierigkeit", bestStreakLabel: "Beste Serie", itemUnit: "", accuracyLabel: "Genauigkeit", achievementsEarnedLabel: "Freigeschaltete Erfolge", starsEarnedLabel: "Erhaltene Sterne", gameOverMessage_great: "🎉 Ausgezeichnete Arbeit!", gameOverMessage_good: "👍 Gut gemacht!", gameOverMessage_tryAgain: "💪 Nächstes Mal schaffst du das!", gameOverMessage_cleared: "🏆 Du hast alle Puzzles gemeistert! Legendär!", playAgainButton: "Nochmal Spielen", downloadResult: "Ergebnis herunterladen", imageDownloaded: "Bild heruntergeladen!", imageDownloadFailed: "Bild konnte nicht heruntergeladen werden.", howToPlayButton: "Spielanleitung", howToPlayTitle: "Spielanleitung", howToPlay_goal_title: "Ziel", howToPlay_goal_desc: "Anweisungen für das neue Spiel kommen hierher.", howToPlay_time_lives_title: "Zeit und Bonus", howToPlay_time_lives_desc: "Du startest mit 60 Sekunden. Richtige Antworten geben Bonuszeit (bis zu 60s max) je nach Schwierigkeit. Lass weder die Zeit noch deine Leben ausgehen!", howToPlay_difficulty_title: "Schwierigkeit", howToPlay_difficulty_desc: "Das Spiel passt sich an! Je besser du spielst, desto schwieriger werden die Puzzles und desto mehr Punkte erhältst du.", howToPlay_streak_title: "Serie & Power-Ups", howToPlay_streak_desc: "Erreiche eine 3er-Serie für die Chance auf ein zufälliges Power-Up wie ❄️ Zeitstopp, ❤️ Extraleben und ⚡ Doppelte Punkte!", howToPlay_hints_title: "Tipps", howToPlay_hints_desc: "Steckst du fest? Nutze einen Tipp! Sei vorsichtig, es kostet dich 50% der Punkte für dieses Puzzle.", howToPlay_achievements_title: "Erfolge", howToPlay_achievements_desc: "Schalte besondere Erfolge frei, indem du Meilensteine im Spiel erreichst.", closeButton: "Verstanden!", soundOnTooltip: "Musik abspielen", soundOffTooltip: "Musik stumm schalten", startGameButton: "Spiel Starten", footer_copyright: "Puzzletic. Alle Rechte vorbehalten.", footer_contact: "Geschäftskontakt:" },
  pt: { title: "Fruit Slashy", subtitle: "Crie o número alvo com a faca!", scoreLabel: "Pontos", livesLabel: "Vidas", streakLabel: "Sequência", timeLabel: "Tempo", difficulty_1: "Iniciante", difficulty_2: "Intermediário", difficulty_3: "Avançado", question: "Sua pergunta aqui...", doubleScoreActive: "⚡2x ({timeLeft}s)", hintButton: "💡 Dica ({remaining}/3)", hintButtonClose: "Fechar Dica", hintLabel: "Dica:", hintUsedText: "(Dica usada, 50% de penalidade)", hintText_placeholder: "O texto da sua dica vai aqui.", feedbackCorrect: "Correto! +{score} pontos", feedbackEmojiCorrect: "🎉", feedbackWrong: "Incorreto. 💔", achievementsTitle: "Conquistas ({count}/4)", achievements_firstCorrect: "Primeiro Corte", achievements_lightningSpeed: "Cálculo Rápido", achievements_streakMaster: "Rei do Combo", achievements_master: "Mestre das Frutas", achievementsTooltip_firstCorrect: "Resolva seu primeiro quebra-cabeça.", achievementsTooltip_lightningSpeed: "Responda em menos de 3 segundos.", achievementsTooltip_streakMaster: "Obtenha uma sequência de 5 quebra-cabeças.", achievementsTooltip_master: "Resolva 3+ quebra-cabeças na dificuldade Avançado.", gameOverTitle: "Fim de Jogo!", gameOverBadge: "Fim", finalScoreLabel: "Pontuação Final", scoreUnit: " pts", difficultyReachedLabel: "Dificuldade Alcançada", bestStreakLabel: "Melhor Sequência", itemUnit: "", accuracyLabel: "Precisão", achievementsEarnedLabel: "Conquistas Desbloqueadas", starsEarnedLabel: "Estrelas Ganhas", gameOverMessage_great: "🎉 Excelente trabalho!", gameOverMessage_good: "👍 Bem feito!", gameOverMessage_tryAgain: "💪 Você consegue fazer melhor da próxima vez!", gameOverMessage_cleared: "🏆 Você dominou todos os quebra-cabeças! Lendário!", playAgainButton: "Jogar Novamente", downloadResult: "Baixar Resultado", imageDownloaded: "Imagem baixada!", imageDownloadFailed: "Falha ao baixar a imagem.", howToPlayButton: "Como Jogar", howToPlayTitle: "Como Jogar", howToPlay_goal_title: "Objetivo", howToPlay_goal_desc: "As instruções do novo jogo vão aqui.", howToPlay_time_lives_title: "Tempo e Bônus", howToPlay_time_lives_desc: "Você começa com 60 segundos. Responder corretamente concede tempo bônus (até 60s no máximo) com base na dificuldade. Não deixe o tempo ou suas vidas acabarem!", howToPlay_difficulty_title: "Dificuldade", howToPlay_difficulty_desc: "O jogo se adapta! Quanto melhor você joga, mais difíceis os quebra-cabeças se tornam, e mais pontos você ganha.", howToPlay_streak_title: "Sequência e Power-ups", howToPlay_streak_desc: "Alcance uma sequência de 3 quebra-cabeças para ter a chance de ganhar um power-up aleatório como ❄️ Congelar Tempo, ❤️ Vida Extra e ⚡ Pontuação em Dobro!", howToPlay_hints_title: "Dicas", howToPlay_hints_desc: "Preso? Use uma dica! Cuidado, custará 50% dos pontos do quebra-cabeça.", howToPlay_achievements_title: "Conquistas", howToPlay_achievements_desc: "Desbloqueie conquistas especiais ao completar marcos no jogo.", closeButton: "Entendi!", soundOnTooltip: "Tocar música", soundOffTooltip: "Silenciar música", startGameButton: "Começar Jogo", footer_copyright: "Puzzletic. Todos os direitos reservados.", footer_contact: "Contato comercial:" },
  it: { title: "Fruit Slashy", subtitle: "Crea il numero target con il coltello!", scoreLabel: "Punteggio", livesLabel: "Vite", streakLabel: "Serie", timeLabel: "Tempo", difficulty_1: "Principiante", difficulty_2: "Intermedio", difficulty_3: "Avanzato", question: "La tua domanda qui...", doubleScoreActive: "⚡2x ({timeLeft}s)", hintButton: "💡 Suggerimento ({remaining}/3)", hintButtonClose: "Chiudi Suggerimento", hintLabel: "Suggerimento:", hintUsedText: "(Suggerimento usato, penalità 50%)", hintText_placeholder: "Il testo del tuo suggerimento va qui.", feedbackCorrect: "Corretto! +{score} punti", feedbackEmojiCorrect: "🎉", feedbackWrong: "Errato. 💔", achievementsTitle: "Obiettivi ({count}/4)", achievements_firstCorrect: "Primo Taglio", achievements_lightningSpeed: "Calcolo Veloce", achievements_streakMaster: "Re del Combo", achievements_master: "Maestro della Frutta", achievementsTooltip_firstCorrect: "Risolvi il tuo primo puzzle.", achievementsTooltip_lightningSpeed: "Rispondi in meno di 3 secondi.", achievementsTooltip_streakMaster: "Ottieni una serie di 5 puzzle.", achievementsTooltip_master: "Risolvi 3+ puzzle a difficoltà Avanzato.", gameOverTitle: "Fine Partita!", gameOverBadge: "Fine", finalScoreLabel: "Punteggio Finale", scoreUnit: " pti", difficultyReachedLabel: "Difficoltà Raggiunta", bestStreakLabel: "Miglior Serie", itemUnit: "", accuracyLabel: "Precisione", achievementsEarnedLabel: "Obiettivi Sbloccati", starsEarnedLabel: "Stelle Ottenute", gameOverMessage_great: "🎉 Ottimo lavoro!", gameOverMessage_good: "👍 Ben fatto!", gameOverMessage_tryAgain: "💪 La prossima volta andrà meglio!", gameOverMessage_cleared: "🏆 Hai padroneggiato tutti i puzzle! Leggendario!", playAgainButton: "Gioca Ancora", downloadResult: "Scarica Risultato", imageDownloaded: "Immagine scaricata!", imageDownloadFailed: "Download dell'immagine non riuscito.", howToPlayButton: "Come Giocare", howToPlayTitle: "Come Giocare", howToPlay_goal_title: "Obiettivo", howToPlay_goal_desc: "Le istruzioni del nuovo gioco vanno qui.", howToPlay_time_lives_title: "Tempo e Bonus", howToPlay_time_lives_desc: "Inizi con 60 secondi. Rispondere correttamente assegna tempo bonus (fino a 60s max) in base alla difficoltà. Non lasciare che il timer o le tue vite si esauriscano!", howToPlay_difficulty_title: "Difficoltà", howToPlay_difficulty_desc: "Il gioco si adatta! Meglio giochi, più difficili diventano i puzzle, facendoti guadagnare più punti.", howToPlay_streak_title: "Serie & Potenziamenti", howToPlay_streak_desc: "Ottieni una serie di 3 puzzle per avere la possibilità di guadagnare un potenziamento casuale come ❄️ Congela Tempo, ❤️ Vita Extra e ⚡ Punteggio Doppio!", howToPlay_hints_title: "Suggerimenti", howToPlay_hints_desc: "Bloccato? Usa un suggerimento! Attenzione, ti costerà il 50% del punteggio per quel puzzle.", howToPlay_achievements_title: "Obiettivi", howToPlay_achievements_desc: "Sblocca obiettivi speciali completando traguardi nel gioco.", closeButton: "Capito!", soundOnTooltip: "Riproduci musica", soundOffTooltip: "Disattiva audio", startGameButton: "Inizia Partita", footer_copyright: "Puzzletic. Tutti i diritti riservati.", footer_contact: "Contatto commerciale:" },
  ru: { title: "Fruit Slashy", subtitle: "Создайте целевое число с помощью ножа!", scoreLabel: "Счет", livesLabel: "Жизни", streakLabel: "Серия", timeLabel: "Время", difficulty_1: "Новичок", difficulty_2: "Средний", difficulty_3: "Продвинутый", question: "Ваш вопрос здесь...", doubleScoreActive: "⚡2x ({timeLeft}с)", hintButton: "💡 Подсказка ({remaining}/3)", hintButtonClose: "Закрыть подсказку", hintLabel: "Подсказка:", hintUsedText: "(Подсказка использована, штраф 50%)", hintText_placeholder: "Текст вашей подсказки будет здесь.", feedbackCorrect: "Верно! +{score} очков", feedbackEmojiCorrect: "🎉", feedbackWrong: "Неверно. 💔", achievementsTitle: "Достижения ({count}/4)", achievements_firstCorrect: "Первый разрез", achievements_lightningSpeed: "Быстрый подсчет", achievements_streakMaster: "Король комбо", achievements_master: "Мастер фруктов", achievementsTooltip_firstCorrect: "Решите свою первую головоломку.", achievementsTooltip_lightningSpeed: "Ответьте менее чем за 3 секунды.", achievementsTooltip_streakMaster: "Соберите серию из 5 головоломок.", achievementsTooltip_master: "Решите 3+ головоломки на сложности 'Продвинутый'.", gameOverTitle: "Игра Окончена!", gameOverBadge: "Конец", finalScoreLabel: "Итоговый Счет", scoreUnit: " очк", difficultyReachedLabel: "Достигнутая Сложность", bestStreakLabel: "Лучшая Серия", itemUnit: "", accuracyLabel: "Точность", achievementsEarnedLabel: "Открытые Достижения", starsEarnedLabel: "Заработано звёзд", gameOverMessage_great: "🎉 Отличная работа!", gameOverMessage_good: "👍 Хорошо сделано!", gameOverMessage_tryAgain: "💪 В следующий раз у вас получится лучше!", gameOverMessage_cleared: "🏆 Вы освоили все головоломки! Легендарно!", playAgainButton: "Играть Снова", downloadResult: "Скачать результат", imageDownloaded: "Изображение скачано!", imageDownloadFailed: "Не удалось скачать изображение.", howToPlayButton: "Как играть", howToPlayTitle: "Как играть", howToPlay_goal_title: "Цель", howToPlay_goal_desc: "Инструкции к новой игре находятся здесь.", howToPlay_time_lives_title: "Время и Бонус", howToPlay_time_lives_desc: "Вы начинаете с 60 секунд. Правильный ответ дает бонусное время (до 60с макс) в зависимости от сложности. Не позволяйте таймеру или вашим жизням закончиться!", howToPlay_difficulty_title: "Сложность", howToPlay_difficulty_desc: "Игра адаптируется! Чем лучше вы играете, тем сложнее становятся головоломки и тем больше очков вы зарабатываете.", howToPlay_streak_title: "Серия и Усиления", howToPlay_streak_desc: "Соберите серию из 3 головоломок, чтобы получить шанс на случайное усиление, такое как ❄️ Заморозка Времени, ❤️ Дополнительная Жизнь и ⚡ Двойной Счет!", howToPlay_hints_title: "Подсказки", howToPlay_hints_desc: "Застряли? Используйте подсказку! Будьте осторожны, это будет стоить вам 50% очков за эту головоломку.", howToPlay_achievements_title: "Достижения", howToPlay_achievements_desc: "Открывайте особые достижения, выполняя важные этапы в игре.", closeButton: "Понятно!", soundOnTooltip: "Включить музыку", soundOffTooltip: "Отключить музыку", startGameButton: "Начать Игру", footer_copyright: "Puzzletic. Все права защищены.", footer_contact: "Деловой контакт:" },
  ar: { title: "Fruit Slashy", subtitle: "أنشئ الرقم المستهدف بالسكين!", scoreLabel: "النقاط", livesLabel: "الأرواح", streakLabel: "سلسلة", timeLabel: "الوقت", difficulty_1: "مبتدئ", difficulty_2: "متوسط", difficulty_3: "متقدم", question: "سؤالك هنا...", doubleScoreActive: "⚡x ({timeLeft} ث)", hintButton: "💡 تلميح ({remaining}/3)", hintButtonClose: "إغلاق التلميح", hintLabel: "تلميح:", hintUsedText: "(تم استخدام تلميح, خصم 50%)", hintText_placeholder: "نص تلميحك يذهب هنا.", feedbackCorrect: "صحيح! +{score} نقطة", feedbackEmojiCorrect: "🎉", feedbackWrong: "غير صحيح. 💔", achievementsTitle: "الإنجازات ({count}/4)", achievements_firstCorrect: "أول شريحة", achievements_lightningSpeed: "حساب سريع", achievements_streakMaster: "ملك الكومبو", achievements_master: "سيد الفاكهة", achievementsTooltip_firstCorrect: "حل لغزك الأول.", achievementsTooltip_lightningSpeed: "أجب في أقل من 3 ثوان.", achievementsTooltip_streakMaster: "حقق سلسلة من 5 ألغاز.", achievementsTooltip_master: "حل 3+ ألغاز على صعوبة متقدم.", gameOverTitle: "انتهت اللعبة!", gameOverBadge: "النهاية", finalScoreLabel: "النتيجة النهائية", scoreUnit: " نقطة", difficultyReachedLabel: "الصعوبة التي تم الوصول إليها", bestStreakLabel: "أفضل سلسلة", itemUnit: "", accuracyLabel: "الدقة", achievementsEarnedLabel: "الإنجازات المكتسبة", starsEarnedLabel: "النجوم المكتسبة", gameOverMessage_great: "🎉 عمل ممتاز!", gameOverMessage_good: "👍 أحسنت صنعًا!", gameOverMessage_tryAgain: "💪 يمكنك أن تفعل ما هو أفضل في المرة القادمة!", gameOverMessage_cleared: "🏆 لقد أتقنت كل الألغاز! أسطوري!", playAgainButton: "العب مرة أخرى", downloadResult: "تنزيل النتيجة", imageDownloaded: "تم تنزيل الصورة!", imageDownloadFailed: "فشل تنزيل الصورة.", howToPlayButton: "كيفية اللعب", howToPlayTitle: "كيفية اللعب", howToPlay_goal_title: "الهدف", howToPlay_goal_desc: "تعليمات اللعبة الجديدة تذهب هنا.", howToPlay_time_lives_title: "الوقت والمكافأة", howToPlay_time_lives_desc: "تبدأ بـ 60 ثانية. الإجابة الصحيحة تمنح وقتًا إضافيًا (بحد أقصى 60 ثانية) بناءً على الصعوبة. لا تدع الوقت أو حياتك تنفد!", howToPlay_difficulty_title: "الصعوبة", howToPlay_difficulty_desc: "اللعبة تتكيف! كلما لعبت بشكل أفضل، أصبحت الألغاز أصعب، وكسبت المزيد من النقاط.", howToPlay_streak_title: "السلسلة والتعزيزات", howToPlay_streak_desc: "حقق سلسلة من 3 ألغاز للحصول على فرصة لربح تعزيز عشوائي مثل ❄️ تجميد الوقت، ❤️ حياة إضافية، و ⚡ نقاط مضاعفة!", howToPlay_hints_title: "تلميحات", howToPlay_hints_desc: "عالق؟ استخدم تلميحًا! كن حذرًا، سيكلفك 50٪ من نقاط هذا اللغز.", howToPlay_achievements_title: "الإنجازات", howToPlay_achievements_desc: "افتح الإنجازات الخاصة لإكمال المعالم في اللعبة.", closeButton: "فهمت!", soundOnTooltip: "تشغيل الموسيقى", soundOffTooltip: "كتم الموسيقى", startGameButton: "ابدأ اللعبة", footer_copyright: "Puzzletic. جميع الحقوق محفوظة.", footer_contact: "اتصال تجاري:" },
  zh: { title: "水果斩", subtitle: "用刀创造目标数字！", scoreLabel: "分数", livesLabel: "生命", streakLabel: "连击", timeLabel: "时间", difficulty_1: "初级", difficulty_2: "中级", difficulty_3: "高级", question: "你的问题在这里...", doubleScoreActive: "⚡x ({timeLeft}秒)", hintButton: "💡 提示 ({remaining}/3)", hintButtonClose: "关闭提示", hintLabel: "提示：", hintUsedText: "(已用提示, 扣除50%分数)", hintText_placeholder: "你的提示文本放在这里。", feedbackCorrect: "正确！+{score}分", feedbackEmojiCorrect: "🎉", feedbackWrong: "错误。💔", achievementsTitle: "成就 ({count}/4)", achievements_firstCorrect: "第一刀", achievements_lightningSpeed: "速算", achievements_streakMaster: "连击王", achievements_master: "水果大师", achievementsTooltip_firstCorrect: "解决你的第一个谜题。", achievementsTooltip_lightningSpeed: "在3秒内回答。", achievementsTooltip_streakMaster: "获得5个谜题的连击。", achievementsTooltip_master: "在高级难度下正确解决3个以上谜题。", gameOverTitle: "游戏结束！", gameOverBadge: "完", finalScoreLabel: "最终得分", scoreUnit: "分", difficultyReachedLabel: "达到的难度", bestStreakLabel: "最佳连击", itemUnit: "个", accuracyLabel: "准确率", achievementsEarnedLabel: "已解锁成就", starsEarnedLabel: "获得星数", gameOverMessage_great: "🎉 太棒了！", gameOverMessage_good: "👍 做得好！", gameOverMessage_tryAgain: "💪 下次可以做得更好！", gameOverMessage_cleared: "🏆 你已经掌握了所有谜题！太传奇了！", playAgainButton: "再玩一次", downloadResult: "下载结果", imageDownloaded: "图片已下载！", imageDownloadFailed: "图片下载失败。", howToPlayButton: "怎么玩", howToPlayTitle: "游戏玩法", howToPlay_goal_title: "目标", howToPlay_goal_desc: "新游戏的说明放在这里。", howToPlay_time_lives_title: "时间与奖励", howToPlay_time_lives_desc: "你从60秒开始。正确回答会根据难度奖励额外时间（最多60秒）。不要让计时器或你的生命耗尽！", howToPlay_difficulty_title: "难度", howToPlay_difficulty_desc: "游戏会适应！你玩得越好，谜题就越难，你获得的分数就越多。", howToPlay_streak_title: "连击与道具", howToPlay_streak_desc: "连续完成3个谜题，有机会获得随机道具，如❄️时间冻结、❤️额外生命和⚡双倍分数！", howToPlay_hints_title: "提示", howToPlay_hints_desc: "卡住了？使用提示！小心，这会让你失去该谜题50%的分数。", howToPlay_achievements_title: "成就", howToPlay_achievements_desc: "完成游戏中的里程碑，解锁特殊成就。", closeButton: "好的！", soundOnTooltip: "播放音乐", soundOffTooltip: "静音", startGameButton: "开始游戏", footer_copyright: "Puzzletic. 版权所有。", footer_contact: "商务联系：" },
  ja: { title: "フルーツスラッシー", subtitle: "ナイフで目標の数字を作ろう！", scoreLabel: "スコア", livesLabel: "ライフ", streakLabel: "ストリーク", timeLabel: "時間", difficulty_1: "初級", difficulty_2: "中級", difficulty_3: "上級", question: "あなたの質問はここに...", doubleScoreActive: "⚡x ({timeLeft}秒)", hintButton: "💡 ヒント ({remaining}/3)", hintButtonClose: "ヒントを閉じる", hintLabel: "ヒント：", hintText_placeholder: "ヒントのテキストはここに表示されます。", feedbackCorrect: "正解！+{score}ポイント", feedbackEmojiCorrect: "🎉", feedbackWrong: "不正解です。💔", achievementsTitle: "実績 ({count}/4)", achievements_firstCorrect: "初スライス", achievements_lightningSpeed: "速算", achievements_streakMaster: "コンボキング", achievements_master: "フルーツマスター", achievementsTooltip_firstCorrect: "最初のパズルを解く。", achievementsTooltip_lightningSpeed: "3秒以内に回答する。", achievementsTooltip_streakMaster: "5問連続で正解する。", achievementsTooltip_master: "上級難易度で3問以上正解する。", gameOverTitle: "ゲームオーバー！", gameOverBadge: "終", finalScoreLabel: "最終スコア", scoreUnit: "点", difficultyReachedLabel: "到達難易度", bestStreakLabel: "最高ストリーク", itemUnit: "個", accuracyLabel: "正解率", achievementsEarnedLabel: "解除された実績", starsEarnedLabel: "獲得した星", gameOverMessage_great: "🎉 素晴らしい！", gameOverMessage_good: "👍 よくできました！", gameOverMessage_tryAgain: "💪 次はもっとうまくできる！", gameOverMessage_cleared: "🏆 全てのパズルをマスターしました！伝説的です！", playAgainButton: "もう一度プレイ", downloadResult: "結果をダウンロード", imageDownloaded: "画像をダウンロードしました！", imageDownloadFailed: "画像のダウンロードに失敗しました。", howToPlayButton: "遊び方", howToPlayTitle: "遊び方", howToPlay_goal_title: "目標", howToPlay_goal_desc: "新しいゲームの説明はここにあります。", howToPlay_time_lives_title: "時間とボーナス", howToPlay_time_lives_desc: "60秒でスタートします。正解すると難易度に応じてボーナスタイムがもらえます（最大60秒）。時間やライフが尽きないように注意してください！", howToPlay_difficulty_title: "難易度", howToPlay_difficulty_desc: "ゲームはあなたの腕前に適応します！上手にプレイするほどパズルは難しくなり、より多くのポイントを獲得できます。", howToPlay_streak_title: "ストリークとパワーアップ", howToPlay_streak_desc: "3問連続正解すると、❄️時間停止、❤️追加ライフ、⚡スコア2倍などのパワーアップをランダムで獲得するチャンスがあります！", howToPlay_hints_title: "ヒント", howToPlay_hints_desc: "行き詰まりましたか？ヒントを使いましょう！注意：そのパズルのスコアの50%が引かれます。", howToPlay_achievements_title: "実績", howToPlay_achievements_desc: "ゲーム内のマイルストーンを達成して、特別な実績を解除しましょう。", closeButton: "わかった！", soundOnTooltip: "音楽を再生", soundOffTooltip: "ミュート", startGameButton: "ゲーム開始", footer_copyright: "Puzzletic. 全著作権所有。", footer_contact: "ビジネスお問い合わせ：" },
  vi: { title: "Fruit Slashy", subtitle: "Tạo số mục tiêu bằng dao!", scoreLabel: "Điểm", livesLabel: "Mạng", streakLabel: "Chuỗi", timeLabel: "Thời gian", difficulty_1: "Người mới bắt đầu", difficulty_2: "Trung bình", difficulty_3: "Nâng cao", question: "Câu hỏi của bạn ở đây...", doubleScoreActive: "⚡x ({timeLeft}s)", hintButton: "💡 Gợi ý ({remaining}/3)", hintButtonClose: "Đóng gợi ý", hintLabel: "Gợi ý:", hintUsedText: "(Đã dùng gợi ý, trừ 50% điểm)", hintText_placeholder: "Nội dung gợi ý của bạn ở đây.", feedbackCorrect: "Chính xác! +{score} điểm", feedbackEmojiCorrect: "🎉", feedbackWrong: "Sai rồi. 💔", achievementsTitle: "Thành tích ({count}/4)", achievements_firstCorrect: "Lát cắt đầu tiên", achievements_lightningSpeed: "Tính nhanh", achievements_streakMaster: "Vua Combo", achievements_master: "Bậc thầy trái cây", achievementsTooltip_firstCorrect: "Giải câu đố đầu tiên của bạn.", achievementsTooltip_lightningSpeed: "Trả lời trong vòng 3 giây.", achievementsTooltip_streakMaster: "Đạt chuỗi 5 câu đố.", achievementsTooltip_master: "Giải đúng 3+ câu đố ở độ khó Nâng cao.", gameOverTitle: "Trò chơi kết thúc!", gameOverBadge: "Hết", finalScoreLabel: "Điểm cuối cùng", scoreUnit: " điểm", difficultyReachedLabel: "Độ khó đạt được", bestStreakLabel: "Chuỗi tốt nhất", itemUnit: "", accuracyLabel: "Độ chính xác", achievementsEarnedLabel: "Thành tích đã mở khóa", starsEarnedLabel: "Sao kiếm được", gameOverMessage_great: "🎉 Làm tốt lắm!", gameOverMessage_good: "👍 Hay lắm!", gameOverMessage_tryAgain: "💪 Bạn có thể làm tốt hơn vào lần sau!", gameOverMessage_cleared: "🏆 Bạn đã làm chủ tất cả các câu đố! Huyền thoại!", playAgainButton: "Chơi lại", downloadResult: "Tải xuống kết quả", imageDownloaded: "Đã tải xuống hình ảnh!", imageDownloadFailed: "Không tải được hình ảnh.", howToPlayButton: "Cách chơi", howToPlayTitle: "Cách chơi", howToPlay_goal_title: "Mục tiêu", howToPlay_goal_desc: "Hướng dẫn trò chơi mới ở đây.", howToPlay_time_lives_title: "Thời gian & Tiền thưởng", howToPlay_time_lives_desc: "Bạn bắt đầu với 60 giây. Trả lời đúng sẽ nhận được thời gian thưởng (tối đa 60 giây) dựa trên độ khó. Đừng để hết giờ hoặc mạng!", howToPlay_difficulty_title: "Độ khó", howToPlay_difficulty_desc: "Trò chơi sẽ thích ứng! Bạn chơi càng giỏi, câu đố càng khó, bạn càng kiếm được nhiều điểm.", howToPlay_streak_title: "Chuỗi & Vật phẩm hỗ trợ", howToPlay_streak_desc: "Đạt được chuỗi 3 câu đố để có cơ hội nhận được vật phẩm hỗ trợ ngẫu nhiên như ❄️ Đóng băng thời gian, ❤️ Thêm mạng, và ⚡ Nhân đôi điểm!", howToPlay_hints_title: "Gợi ý", howToPlay_hints_desc: "Bị kẹt? Hãy sử dụng gợi ý! Cẩn thận, bạn sẽ bị trừ 50% điểm cho câu đố đó.", howToPlay_achievements_title: "Thành tích", howToPlay_achievements_desc: "Mở khóa các thành tích đặc biệt bằng cách hoàn thành các cột mốc trong trò chơi.", closeButton: "Đã hiểu!", soundOnTooltip: "Bật nhạc", soundOffTooltip: "Tắt nhạc", startGameButton: "Bắt đầu chơi", footer_copyright: "Puzzletic. Mọi quyền được bảo lưu.", footer_contact: "Liên hệ kinh doanh:" },
  th: { title: "Fruit Slashy", subtitle: "สร้างตัวเลขเป้าหมายด้วยมีด!", scoreLabel: "คะแนน", livesLabel: "ชีวิต", streakLabel: "สตรีค", timeLabel: "เวลา", difficulty_1: "เริ่มต้น", difficulty_2: "ปานกลาง", difficulty_3: "ขั้นสูง", question: "คำถามของคุณที่นี่...", doubleScoreActive: "⚡x ({timeLeft}วิ)", hintButton: "💡 คำใบ้ ({remaining}/3)", hintButtonClose: "ปิดคำใบ้", hintLabel: "คำใบ้:", hintUsedText: "(ใช้คำใบ้, หัก 50% คะแนน)", hintText_placeholder: "ข้อความคำใบ้ของคุณจะปรากฏที่นี่", feedbackCorrect: "ถูกต้อง! +{score} คะแนน", feedbackEmojiCorrect: "🎉", feedbackWrong: "ไม่ถูกต้อง 💔", achievementsTitle: "ความสำเร็จ ({count}/4)", achievements_firstCorrect: "การฟันครั้งแรก", achievements_lightningSpeed: "คิดเลขเร็ว", achievements_streakMaster: "เจ้าแห่งคอมโบ", achievements_master: "จ้าวแห่งผลไม้", achievementsTooltip_firstCorrect: "แก้ปริศนาแรกของคุณ", achievementsTooltip_lightningSpeed: "ตอบภายใน 3 วินาที", achievementsTooltip_streakMaster: "ทำสตรีค 5 ปริศนา", achievementsTooltip_master: "แก้ปริศนา 3+ ข้อในระดับความยากขั้นสูง", gameOverTitle: "เกมจบแล้ว!", gameOverBadge: "จบ", finalScoreLabel: "คะแนนสุดท้าย", scoreUnit: " คะแนน", difficultyReachedLabel: "ระดับความยากที่ไปถึง", bestStreakLabel: "สตรีคสูงสุด", itemUnit: "", accuracyLabel: "ความแม่นยำ", achievementsEarnedLabel: "ความสำเร็จที่ปลดล็อค", starsEarnedLabel: "ดาวที่ได้รับ", gameOverMessage_great: "🎉 ยอดเยี่ยมมาก!", gameOverMessage_good: "👍 ทำได้ดีมาก!", gameOverMessage_tryAgain: "💪 ครั้งหน้าต้องดีกว่านี้!", gameOverMessage_cleared: "🏆 คุณเชี่ยวชาญปริศนาทั้งหมดแล้ว! สุดยอด!", playAgainButton: "เล่นอีกครั้ง", downloadResult: "ดาวน์โหลดผลลัพธ์", imageDownloaded: "ดาวน์โหลดรูปภาพแล้ว!", imageDownloadFailed: "ดาวน์โหลดรูปภาพไม่สำเร็จ", howToPlayButton: "วิธีเล่น", howToPlayTitle: "วิธีเล่น", howToPlay_goal_title: "เป้าหมาย", howToPlay_goal_desc: "คำแนะนำเกมใหม่อยู่ที่นี่", howToPlay_time_lives_title: "เวลาและโบนัส", howToPlay_time_lives_desc: "คุณเริ่มต้นด้วยเวลา 60 วินาที การตอบถูกจะได้รับเวลาโบนัส (สูงสุด 60 วินาที) ตามระดับความยาก อย่าปล่อยให้เวลาหรือชีวิตหมด!", howToPlay_difficulty_title: "ระดับความยาก", howToPlay_difficulty_desc: "เกมจะปรับตาม! ยิ่งคุณเล่นเก่ง ปริศนาก็จะยิ่งยากขึ้น และคุณจะได้รับคะแนนมากขึ้น", howToPlay_streak_title: "สตรีคและพาวเวอร์อัป", howToPlay_streak_desc: "ทำสตรีค 3 ปริศนาเพื่อลุ้นรับพาวเวอร์อัปแบบสุ่ม เช่น ❄️ หยุดเวลา, ❤️ ชีวิตพิเศษ, และ ⚡ คะแนนสองเท่า!", howToPlay_hints_title: "คำใบ้", howToPlay_hints_desc: "ติดขัด? ใช้คำใบ้! ระวัง มันจะหักคะแนน 50% สำหรับปริศนานั้น", howToPlay_achievements_title: "ความสำเร็จ", howToPlay_achievements_desc: "ปลดล็อคความสำเร็จพิเศษโดยการบรรลุเป้าหมายในเกม", closeButton: "เข้าใจแล้ว!", soundOnTooltip: "เล่นเพลง", soundOffTooltip: "ปิดเสียง", startGameButton: "เริ่มเกม", footer_copyright: "Puzzletic. สงวนลิขสิทธิ์", footer_contact: "ติดต่อธุรกิจ:" },
  id: { title: "Fruit Slashy", subtitle: "Buat angka target dengan pisau!", scoreLabel: "Skor", livesLabel: "Nyawa", streakLabel: "Runtutan", timeLabel: "Waktu", difficulty_1: "Pemula", difficulty_2: "Menengah", difficulty_3: "Lanjutan", question: "Pertanyaan Anda di sini...", doubleScoreActive: "⚡x ({timeLeft}d)", hintButton: "💡 Petunjuk ({remaining}/3)", hintButtonClose: "Tutup Petunjuk", hintLabel: "Petunjuk:", hintUsedText: "(Petunjuk digunakan, penalti skor 50%)", hintText_placeholder: "Teks petunjuk Anda ada di sini.", feedbackCorrect: "Benar! +{score} poin", feedbackEmojiCorrect: "🎉", feedbackWrong: "Salah. 💔", achievementsTitle: "Pencapaian ({count}/4)", achievements_firstCorrect: "Potongan Pertama", achievements_lightningSpeed: "Kalkulasi Cepat", achievements_streakMaster: "Raja Kombo", achievements_master: "Master Buah", achievementsTooltip_firstCorrect: "Pecahkan teka-teki pertamamu.", achievementsTooltip_lightningSpeed: "Jawab dalam kurang dari 3 detik.", achievementsTooltip_streakMaster: "Dapatkan runtutan 5 teka-teki.", achievementsTooltip_master: "Selesaikan 3+ teka-teki pada kesulitan Lanjutan.", gameOverTitle: "Permainan Selesai!", gameOverBadge: "Selesai", finalScoreLabel: "Skor Akhir", scoreUnit: " poin", difficultyReachedLabel: "Kesulitan Tercapai", bestStreakLabel: "Runtutan Terbaik", itemUnit: "", accuracyLabel: "Akurasi", achievementsEarnedLabel: "Pencapaian Terbuka", starsEarnedLabel: "Bintang Diperoleh", gameOverMessage_great: "🎉 Kerja bagus!", gameOverMessage_good: "👍 Bagus sekali!", gameOverMessage_tryAgain: "💪 Kamu bisa lebih baik lain kali!", gameOverMessage_cleared: "🏆 Anda telah menguasai semua teka-teki! Legendaris!", playAgainButton: "Main Lagi", downloadResult: "Unduh Hasil", imageDownloaded: "Gambar diunduh!", imageDownloadFailed: "Gagal mengunduh gambar.", howToPlayButton: "Cara Bermain", howToPlayTitle: "Cara Bermain", howToPlay_goal_title: "Tujuan", howToPlay_goal_desc: "Instruksi permainan baru ada di sini.", howToPlay_time_lives_title: "Waktu & Bonus", howToPlay_time_lives_desc: "Anda mulai dengan 60 detik. Menjawab dengan benar memberikan waktu bonus (maksimal 60 detik) berdasarkan kesulitan. Jangan biarkan waktu atau nyawa Anda habis!", howToPlay_difficulty_title: "Kesulitan", howToPlay_difficulty_desc: "Permainan ini adaptif! Semakin baik kamu bermain, semakin sulit teka-tekinya, dan semakin banyak poin yang kamu dapatkan.", howToPlay_streak_title: "Runtutan & Power-up", howToPlay_streak_desc: "Raih runtutan 3 teka-teki untuk kesempatan mendapatkan power-up acak seperti ❄️ Pembekuan Waktu, ❤️ Nyawa Ekstra, dan ⚡ Skor Ganda!", howToPlay_hints_title: "Petunjuk", howToPlay_hints_desc: "Tersangkut? Gunakan petunjuk! Hati-hati, itu akan mengurangi 50% skormu untuk teka-teki itu.", howToPlay_achievements_title: "Pencapaian", howToPlay_achievements_desc: "Buka pencapaian khusus dengan menyelesaikan tonggak sejarah dalam permainan.", closeButton: "Mengerti!", soundOnTooltip: "Putar Musik", soundOffTooltip: "Heningkan Musik", startGameButton: "Mulai Permainan", footer_copyright: "Puzzletic. Hak cipta dilindungi undang-undang.", footer_contact: "Kontak Bisnis:" }
};

// TODO: Define your problem structure here
type Problem = any;
...
// TODO: Implement your new problem generation logic here
const generateProblem = (difficulty: number): Problem => {
  // This is a placeholder. Replace with your actual game logic.
  console.log(`Generating a new problem for difficulty: ${difficulty}`);
  return { id: Math.random(), difficulty: difficulty };
};


const Footer = ({ t }: { t: (key: string, replacements?: Record<string, string | number>) => string }) => (
    <footer className="text-center text-slate-700/80 text-xs py-4 flex-shrink-0">
...
const App = () => {
  ...
  // TODO: `currentProblem` should hold the state for your new game's current puzzle.
  ...
  const gameOverImageAreaRef = useRef<HTMLDivElement>(null);
  ...
  useEffect(() => {
    const audio = new Audio(musicTracks[Math.floor(Math.random() * musicTracks.length)]);
    audio.loop = true;
  ...
  const generateParticles = (type: 'correct' | 'wrong', count = 10, emojiOverride?: string) => {
    ...
    for (let i = 0; i < count; i++) {
      newParticles.push({
        id: Math.random(),
        emoji: emojiOverride || emojis[Math.floor(Math.random() * emojis.length)],
  ...
  const generateNewProblem = useCallback(() => {
    // TODO: Implement logic to set the next puzzle for your game.
    // This could involve fetching from a list, generating on the fly, etc.
    const newProblem = generateProblem(difficultyLevel);
  ...
  const processAnswer = useCallback((isCorrect: boolean) => {
    ...
    if (isCorrect) {
      ...
      let timeBonusMs = 0;
      if (difficultyLevel === 1) timeBonusMs = 2000;
      else if (difficultyLevel === 2) timeBonusMs = 4000;
      else if (difficultyLevel === 3) timeBonusMs = 6000;
      ...
      // TODO: If you track solved problems, you can add logic here to remove the just-solved one.
      // For example: setProblems(prev => prev.filter(p => p.id !== currentProblem.id));
  ...
  }, [questionStartTime, adjustDifficulty, streak, hintUsed, doubleScoreActive, t, achievements, difficultyLevel, lives, generateNewProblem]);


  // TODO: Your game logic should call processAnswer(isCorrect) when the user submits an answer.
  // For example, on a button click:
  // const handleUserAnswer = (userAnswer) => {
  //   const isCorrect = checkAnswer(userAnswer); // Your logic to check correctness
  //   processAnswer(isCorrect);
  // }
  
  const setupNewGame = useCallback(() => {
    // TODO: Set up initial state for a new game.
    // This could involve generating a full set of puzzles.
    // For now, we just generate the first problem.
  ...
  const handleDownloadImage = useCallback(() => {
    if (gameOverImageAreaRef.current === null) {
      return;
    }
    setToast(null);

    toPng(gameOverImageAreaRef.current, {
      cacheBust: true,
      pixelRatio: 2,
    })
      .then((dataUrl) => {
        const link = document.createElement('a');
        link.download = 'fruit-slashy-result.png';
        link.href = dataUrl;
        link.click();
  ...
  if (gameState === 'gameover') {
    ...
    return (
      <div className="min-h-screen bg-[#e9d5ff] flex flex-col items-center justify-center p-4 font-sans">
        <main className="flex-grow flex flex-col items-center justify-center w-full">
          <div className="w-full max-w-sm">
            <div ref={gameOverImageAreaRef}>
              <div className="bg-gradient-to-br from-[#e9d5ff] via-[#b1b2fb] to-[#fecdd3] p-4 rounded-xl shadow-2xl">
                <div className="text-center mb-4">
                    <h1 className="text-3xl md:text-4xl font-bold text-slate-800 drop-shadow-md">{t('title')}</h1>
                    <p className="text-sm md:text-base text-slate-700 opacity-90">{t('subtitle')}</p>
                </div>
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-6 text-center w-full relative">
        ...
        <footer className="text-center text-gray-600 text-xs py-4 flex-shrink-0">
            <p>© {new Date().getFullYear()} {t('footer_copyright')}</p>
            <p>
                {t('footer_contact')}{' '}
                <a href="mailto:puzzletic.app@gmail.com" className="underline hover:text-gray-800 transition-colors">
                    puzzletic.app@gmail.com
                </a>
            </p>
        </footer>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#e9d5ff] via-[#b1b2fb] to-[#fecdd3] p-4 relative overflow-hidden font-sans flex flex-col">
      ...
      <main className="flex-grow">
          <div className="absolute top-4 left-4 right-4 z-20 flex justify-between items-center">
                <div className="flex items-center gap-2">
                    <button onClick={() => setHelpModalOpen(true)} aria-label={t('howToPlayButton')} className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-slate-800 bg-white/30 hover:bg-white/50 rounded-full transition-all backdrop-blur-sm"><HelpCircle className="w-4 h-4" /><span>{t('howToPlayButton')}</span></button>
                    <button 
                        onClick={toggleSoundEnabled} 
                        aria-label={isSoundEnabled ? t('soundOffTooltip') : t('soundOnTooltip')}
                        title={isSoundEnabled ? t('soundOffTooltip') : t('soundOnTooltip')} 
                        className="p-2 text-sm font-medium text-slate-800 bg-white/30 hover:bg-white/50 rounded-full transition-all backdrop-blur-sm"
                    >
                        {isSoundEnabled ? <Volume2 className="w-5 h-5" /> : <VolumeX className="w-5 h-5" />}
                    </button>
                </div>
                <div className="relative" ref={dropdownRef}>
                    <button onClick={() => setLangDropdownOpen(!isLangDropdownOpen)} aria-label="Change language" aria-haspopup="true" aria-expanded={isLangDropdownOpen} className="flex items-center justify-between w-full px-3 py-2 text-sm font-medium text-slate-800 bg-white/30 hover:bg-white/50 rounded-full transition-all backdrop-blur-sm"><span>{supportedLangs.find(l => l.code === languageCode)?.name}</span><ChevronDown className={`w-4 h-4 ml-2 transition-transform ${isLangDropdownOpen ? 'rotate-180' : ''}`} /></button>
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="space-y-2">
              <div className="grid grid-cols-3 gap-2">
                <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-2 text-center"><div className="text-slate-600 text-xs font-medium opacity-90">{t('scoreLabel')}</div><div className="text-slate-800 text-lg font-bold flex items-center justify-center"><Coins className="w-4 h-4 mr-1 text-yellow-300" />{score}</div></div>
                <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-2 text-center"><div className="text-slate-600 text-xs font-medium opacity-90">{t('livesLabel')}</div><div className="flex justify-center items-center space-x-1 pt-1">{[...Array(3)].map((_, i) => ( <Heart key={i} className={`w-5 h-5 transition-all ${ i < lives ? 'text-red-500 fill-current' : 'text-slate-500 opacity-30' }`} /> ))}</div></div>
                <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-2 text-center"><div className="text-slate-600 text-xs font-medium opacity-90">{t('streakLabel')}</div><div className="text-slate-800 text-lg font-bold flex items-center justify-center"><Flame className="w-4 h-4 mr-1 text-orange-400" />{streak}</div></div>
              </div>
              ...
              {gameState === 'idle' ? (
                ...
                <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-2 flex items-center gap-3">
                    <div className="relative">
                       <div className={`flex items-center text-slate-800 font-bold text-lg ${ pulseWarning ? 'text-red-500 animate-pulse' : ''}`}><Clock className="w-4 h-4 mr-2" />{timeLeft}s</div>
                       {timeBonusFeedback && <div key={timeBonusFeedback.id} className="absolute -top-5 left-1/2 -translate-x-1/2 text-green-500 font-bold animate-float-up whitespace-nowrap">{timeBonusFeedback.text}</div>}
                    </div>
                    <div className="flex-grow w-full bg-black bg-opacity-10 rounded-full h-2.5 overflow-hidden"><div className={`h-full rounded-full transition-all duration-1000 ease-linear ${ pulseWarning ? 'bg-gradient-to-r from-red-400 to-red-600 animate-pulse' : timeLeft <= 20 ? 'bg-gradient-to-r from-yellow-400 to-orange-500' : 'bg-gradient-to-r from-green-400 to-blue-500' } ${timeFrozen ? 'bg-gradient-to-r from-blue-300 to-cyan-400' : ''}`} style={{ width: `${(timeLeft / 60) * 100}%`}}></div></div>
                    {timeFrozen && <span className="text-blue-400 text-lg">❄️</span>}
                </div>
              )}
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-4 md:p-6 mb-3 min-h-[456px] flex flex-col" style={{ background: '#FFFBEB' }}>
              ...
              <div className="flex-grow flex flex-col">
                {gameState === 'idle' ? (
                    ...
                    <>
                        {/* =============================================================== */}
                        {/* TODO: Implement your new puzzle game UI and logic here.         */}
                        {/* This is the central, interactive area of the game.              */}
                        {/* You can use `currentProblem` state to display the puzzle.       */}
                        {/* Call `processAnswer(isCorrect)` when the user submits an answer.*/}
                        {/* =============================================================== */}
                ...
                <div className="h-16 mt-4">
                   {showHint ? (
                    <div className={`border-l-4 p-2 rounded mt-2 text-sm text-left bg-orange-50 border-orange-400 text-orange-800`}>
                      <p><strong>{t('hintLabel')}</strong> {t('hintText_placeholder')}</p>
                       {hintUsed && <p>{t('hintUsedText')}</p>}
                    </div>
                  ) : feedback ? (
                 ...
                 <button
                    ...
                    className={`px-3 py-1 rounded-full text-xs transition-all w-32 mx-auto block ${ (hintsRemaining === 0 && !showHint) || gameState !== 'playing' ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'bg-gray-300 hover:bg-gray-400 text-gray-800' }`}
                  >
            ...
            <div className="bg-white bg-opacity-90 rounded-lg p-3">
              ...
              <div className="grid grid-cols-4 gap-2">
                ...
                <div title={t('achievementsTooltip_streakMaster')} className={`p-2 rounded-lg text-center transition-all ${achievements.streakMaster ? 'bg-red-100 text-red-800 scale-110' : 'bg-gray-100 text-gray-400'}`}><div className="text-lg mb-1">🔥</div><div className="text-xs font-semibold">{t('achievements_streakMaster')}</div></div>
